    ...
    <>
      ...
      <div className="max-w-4xl mx-auto mt-16">
        ...
        <div className="passwords">
          ...
          <table class="table-auto w-full items-center rounded-md overflow-hidden mt-4">
            ...
            <tbody className="bg-pink-100">
              <tr>
                <td className="py-2 text-center w-32 border border-white">The Sliding Mr. Bones (Next Stop, Pottersville)</td>
                <td className="py-2 text-center w-32 border border-white">Malcolm Lockyer</td>
                <td className="py-2 text-center w-32 border border-white">1961</td>
              </tr>
              <tr>
                <td className="py-2 text-center w-32 border border-white">Witchy Woman</td>
                <td className="py-2 text-center w-32 border border-white">The Eagles</td>
                <td className="py-2 text-center w-32 border border-white">1972</td>
              </tr>
              <tr>
                <td className="py-2 text-center w-32 border border-white">Shining Star</td>
                <td className="py-2 text-center w-32 border border-white">Earth, Wind, and Fire</td>
                <td className="py-2 text-center w-32 border border-white">1975</td>
              </tr>
            </tbody>
          </table>
        </div>
